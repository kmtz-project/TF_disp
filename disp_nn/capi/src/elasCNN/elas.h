...
private:
  ...
  std::vector<support_pt> computeSupportMatches (uint8_t* I1_desc,uint8_t* I2_desc,np::ndarray np_grid);
  ...
  // matching
  void get_CNN_cosine(float* conv_left, float* conv_right, int32_t &u, int32_t &v, int32_t &width,int32_t &u_warp,
                      const int32_t &d, int32_t &val,int32_t &min_val,int32_t &min_d);
  void get_CNN_cosine(float* conv_left, float* conv_right, int32_t &u, int32_t &v, int32_t &width,int32_t &u_warp, const int32_t &w,
                      const int32_t &d, int32_t &val,int32_t &min_val,int32_t &min_d);
